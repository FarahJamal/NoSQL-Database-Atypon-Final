...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Rest Repositories, Spring
...
```
$ docker run --rm -p 8080:8080 NoSQL-Database-Atypon-Final:0.0.1-SNAPSHOT
```
...
```
$ target/NoSQL-Database-Atypon-Final
```
